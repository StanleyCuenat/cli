...
func init() {
	...
	nlbServiceUpdateCmd.Flags().Int64("port", 0, "service port")
	nlbServiceUpdateCmd.Flags().Int64("target-port", 0, "port to forward traffic to on target instances")
	...
	nlbServiceUpdateCmd.Flags().Int64("healthcheck-port", 0, "service health checking port")
